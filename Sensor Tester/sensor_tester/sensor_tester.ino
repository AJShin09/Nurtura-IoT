/*
  ============================================
  Soil Moisture + Environment Sensor — ESP32
  ============================================
  Soil A:  v1.2  → GPIO34
  Soil B:  v2.0  → GPIO35
  BH1750   Light → I2C (SDA=21, SCL=22)
  BME280   Env   → I2C (SDA=16, SCL=17)
  LED             → GPIO2
  ...
  Wiring:
    ...
    BME280 VCC → 3.3V | GND → GND | SDA → GPIO16 | SCL → GPIO17
    Both soil sensor VCC → 3.3V | GND → GND
  ...
  Format:
    DATA,<id>,<raw>,<pct>,<status>           ← soil sensors
    ENV,<lux>,<tempC>,<hum>,<hPa>            ← environment
  ============================================
*/
